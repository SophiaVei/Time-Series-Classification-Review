...
dataset_name = "RacketSports"  # Change this to match your dataset name
#d
# Load the dataset
X_train_raw, y_train = load_UCR_UEA_dataset("RacketSports", split="train", return_X_y=True)
X_test_raw, y_test = load_UCR_UEA_dataset("RacketSports", split="test", return_X_y=True)
...
print("Test set class distribution:", Counter(y_test))  #gg
